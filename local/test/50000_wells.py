...
drich = Run("50000_wells", __file__)
...
drich.TimingInfo.StartTime = 0
drich.TimingInfo.StopTime = 24.0*31.0
drich.TimingInfo.DumpInterval = 1.0
drich.TimeStep.Type = "Constant"
drich.TimeStep.Value = 1.0
...
dir_name = get_absolute_path('test_output/50000_wells')
mkdir(dir_name)
