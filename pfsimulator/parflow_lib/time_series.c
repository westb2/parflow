...
//  TimeSeries* time_series = ctalloc(TimeSeries,1);
...
////      ctalloc(int *, num_cycles);
//  time_series->times = ctalloc(double , time_series->length);
//  time_series->values = ctalloc(double , time_series->length);;
//
//
...
//    time_series->times[time_series_position] = atof(current_times_string);
//    time_series->values[time_series_position] = atof(current_value_string);
